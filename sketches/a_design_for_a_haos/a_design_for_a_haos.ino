 ...
 * Speaker +	G			Black     
 *
 * Piezo Sns+	A0			See : http://www.ttiinc.com/object/te-connectivity-sensor-piezo-dt-series
 * Piezo Sns-   G
 */
...
int red_signal_led = 7;
int ylw_signal_led = 4;
...
void switch_relay(boolean on_if_true)
{
	if (on_if_true)
	{
		// Turn on relay.
